...
export async function POST(req: NextRequest) {
  ...
  // Scheduling is publishing with a delay, so it answers to the same gate. Accepting the job
  // and failing at send time would be worse than refusing now — the post is already missed.
