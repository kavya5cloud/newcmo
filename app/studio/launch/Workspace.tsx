...
export default function LaunchWorkspaceClient(
  { plan, isExample = false }: { plan: LaunchPlan; isExample?: boolean },
) {
  ...
  return (
    <section className="st-section lw">
      <header className="st-shead">
        ...
        {/* Said plainly rather than left to be discovered. Nine agents doing real work on a
            company that is not yours is a demo, and a demo that does not say so is a lie the
            moment someone acts on the plan. */}
        {isExample && (
          <p className="lw-example" role="note">
            This is a worked example on our own company — every number below is real, none of
            it is yours. <a href="/app">Analyse your site</a> and the team re-plans for you.
          </p>
        )}
