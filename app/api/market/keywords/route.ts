...
// Keyword Explorer — discovery, scoring, clusters.
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, ...paginate(brief.keywords, offset, lim), clusters: new (await import("@/lib/market/keywords")).KeywordService().cluster(brief.keywords) });
  } catch (e) {
